...
function validateForm(){
	var a = document.getElementById("customer_ID").value;
	if(a.charAt(0)=='U'){
	 if(a.length==8)
		 return true;
	 else {
...
<div>
  <form action="ViewSpecificCustomerServlet" method="post" ng-app="myApp" ng-controller="validateCtrl" 
name="myForm" novalidate onsubmit="return validateForm()">
    <h3>View Customer</h3>
<br>
    Customer ID/SSN ID : <span ng-show="myForm.customer_ID.$error.required"><font color="tomato"><b>*<b></b></font></span><input type="text" ng-model="customer_ID" id="customer_ID" name="customer_ID" required>
 
    

    <input type="hidden" name="action" value="view">

<button type="submit"  ng-disabled="myForm.customer_ID.$pristine" class="btn btn-info btn-md">
