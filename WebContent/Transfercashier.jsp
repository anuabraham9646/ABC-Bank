...
<h2><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transfer</center></h2>
<form action="TransactionServlet" method="post" onsubmit="return validate()">
<center>
<b>Transfer Amount : <input type="text" id="amt" name="transfer_Amount" required>
<br><br>

Target Account ID : <input id="id" type="text" name="Account_ID2" required><br>
<br>
