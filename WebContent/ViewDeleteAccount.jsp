...
<td>
<form action="DeleteAccountFunctionServlet" method="post" onsubmit="return validate()">


<input type="hidden" id="h1" name="fetchid" value="<%=rs.getString("ACCOUNT_ID")%>">
<input type="hidden" name="status" id= "status" value="<%= rs.getString("STATUS")%>">

<button type="submit" name="action" class="btn btn-default btn-sm">
